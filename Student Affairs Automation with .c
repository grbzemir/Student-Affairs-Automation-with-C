...
void ogrenciEkle() 
{
        ...
        system ("cls") ;
        printf("Ogrenci ekleme islemi ekranina hosgeldiniz \n");
        
        ogr o1;

        FILE *numPtr = fopen("ogrenciNumaralari.txt","r+b");
        int numara;
        numara = 0;
...
{
    system ("cls") ;
    printf("Ogrenci silme islemi ekranina hosgeldiniz \n");
...
void ogrenciAra()
{
  ...
  system ("cls") ;
    printf("Ogrenci arama islemi ekranina hosgeldiniz \n");
   ...
   if(sonuc==0)
   printf("%d no'lu ogrenci bulunamadi",numara);
   else
   {
       printf("%d no'lu ogrenci bilgileri \n",numara);
       printf("tc : %s \n",o1.tc);
       printf("ad soyad : %s \n",o1.adSoyad);
       printf("Bolumu : %d \n",o1.bolumID);
       printf("durumu : %d \n",o1.durum);
